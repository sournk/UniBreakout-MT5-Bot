//=====================================================================
//	Эксперт на индикаторе тренда FanTrendDetector.
//=====================================================================
#property copyright 	"Dima S."
#property link      	"dimascub@mail.com"
#property version   	"1.00"
#property description "Эксперт на индикаторе тренда FanTrendDetector."
//---------------------------------------------------------------------
...
//	Создадим хэндл внешнего индикатора для дальнейшего обращения к нему:
   ResetLastError();
   indicator_handle=iCustom(Symbol(),PERIOD_CURRENT,"Examples\\FanTrendDetector",MA1Period,MA2Period,MA3Period);

//	Если инициализация прошла неудачно, то возвратим ненулевой код:
   if(indicator_handle==INVALID_HANDLE)
     {
      Print("Ошибка инициализации FanTrendDetector, Код = ",GetLastError());
      return(-1);
     }
   return(0);
  }
