//=====================================================================
//	Эксперт на индикаторе тренда NRTRTrendDetector.
//=====================================================================
#property copyright 	"Dima S."
#property link      	"dimascub@mail.com"
#property version   	"1.00"
#property description "Эксперт на индикаторе тренда NRTRTrendDetector."
//---------------------------------------------------------------------
...
//	Создадим хэндл внешнего индикатора для дальнейшего обращения к нему:
   ResetLastError();
   indicator_handle=iCustom(Symbol(),PERIOD_CURRENT,"Examples\\NRTRTrendDetector",ATRPeriod,Koeff);

//	Если инициализация прошла неудачно, то возвратим ненулевой код:
   if(indicator_handle==INVALID_HANDLE)
     {
      Print("Ошибка инициализации NRTRTrendDetector, Код = ",GetLastError());
      return(-1);
     }
   return(0);
  }
