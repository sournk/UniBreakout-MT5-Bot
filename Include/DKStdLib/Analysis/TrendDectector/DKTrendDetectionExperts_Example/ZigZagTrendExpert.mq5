//=====================================================================
//	Эксперт на индикаторе тренда ZigZagTrendDetector.
//=====================================================================
#property copyright 	"Dima S."
#property link      	"dimascub@mail.com"
#property version   	"1.01"
#property description "Эксперт на индикаторе тренда ZigZagTrendDetector."
//---------------------------------------------------------------------
...
//	Если инициализация прошла неудачно, то возвратим ненулевой код:
   if(indicator_handle==INVALID_HANDLE)
     {
      Print("Ошибка инициализации ZigZagTrendDetector, Код = ",GetLastError());
      return(-1);
     }
